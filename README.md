...
追踪你的行为模式（完成率、拖延倾向、情绪触发），注入 AI 回应，让它越来越贴合你的节奏，却不机械地提及数据。当前为基础版行为追踪，「越用越懂你」的个性化体验（记忆延续、行为自适应等）正在积极规划，将在未来版本持续迭代落地。

### 🍚 智能安排

用番茄工作法智能插入休息间隔，并自动参考你的用餐与作息偏好来安排任务，把任务排得既高效又符合你的生活节奏。用餐/作息时段的智能化匹配仍在持续优化中，更多贴心策略将在未来版本持续迭代给出。
